...
// -- 2 : Affecter une valeur à une variable
    ...
    //ou => var Prenom = "Julien";

// -- 3 : une instruction se termine toujours avec un point-virgule ";", aussi il est possible d'écrire plusieurs instructions sur une seul lignes
    // inst_1;
    // inst_2; inst_3;
...
//document.write("A la pause vous aurez des haribots Pik !");
...
//-- 9 : Une variable ne peux pas commencer par un chiffre, ne doit contenir que des caractères alphanumériques, et ne peut pas être un mot réservé (var, for... des éléments natifs du langages JS)
// Mots actuellement réservés >> https://developer.mozilla.org/fr/docs/Web/JavaScript/Reference/Mots_r%C3%A9serv%C3%A9s
...
// -- 6. typeof permet de connaître le type de la variable
...
// -- la fonction parserInt() renvoie un entier à partir d'une chaine de caractères
